...
?>
<form id="formneweditclassroom" action="{{action('ClassroomController@neworedit')}}<?= empty($cod_classroom)?'':"?cod_classroom=$classroom->cod_classroom"?>" method="post" class="form-horizontal" role="form">
  			...
  			<div class="panel-body">
		  		<div class="form-group">
		    		<label for="nombreaula" class="col-sm-3 control-label">Nombre aula:</label>
		   			<div class="col-sm-9">
                                            <input value="<?= empty($cod_classroom)?'':$classroom->classroom_name ?>" type="text" class="form-control" id="nombreaula" name="nombreaula" placeholder="Nombre Aula" >
		   		 	</div>
		  		</div>
		  		<div class="form-group">
		    		<label for="edificio" class="col-sm-3 control-label">Edificio:</label>
		   			<div class="col-sm-9">
		      			<input value="<?= empty($cod_classroom)?'':$classroom->building ?>" type="text" class="form-control" id="edifio"  name="edificio" placeholder="Edificio">
		   		 	</div>
		  		</div>
		  		<div class="form-group">
		    		<label for="capacidad" class="col-sm-3 control-label">Capacidad:</label>
		   			<div class="col-sm-9">
		      			<input value="<?= empty($cod_classroom)?'':$classroom->capacity ?>" type="text" class="form-control" id="capacidad" name="capacidad" placeholder="Capacidad" >
		    		 	</div>
		  		</div>
                            <div class="form-group">
