...
?>
<form id="formnewedit" action="{{action('GrupoController@agregargrupo')}}?cod_classroom={{$classroom->cod_classroom}}" method="post" class="form-horizontal" role="form">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input value='<?= substr($classroom->classroom_name, 0, 1) ?>' type="text" class="form-control" id="nombregrupo" name="nombregrupo" placeholder="Nombre Grupo" required >
                            </div>
                        </div>
