...
c[d]);a.aiDisplay=a.aiDisplayMaster.slice();a.bAjaxDataGet=!1;L(a);a._bInitComplete||pa(a,b);a.bAjaxDataGet=!0;F(a,!1)}function oa(a,b){var c=g.isPlainObject(a.ajax)&&a.ajax.dataSrc!==n?a.ajax.dataSrc:a.sAjaxDataProp;return"data"===c?b.aaData||b[c]:""!==c?U(c)(b):b}function hb(a){var b=a.oClasses,c=a.sTableId,d=a.oPreviousSearch,e=a.aanFeatures,f='<input placeholder="Buscar registro..." type="search" class="'+b.sFilterInput+'"/>',i=a.oLanguage.sSearch,i=i.match(/_INPUT_/)?i.replace("_INPUT_",f):i+f,b=g("<div/>",{id:!e.f?c+"_filter":
null,"class":b.sFilter}).append(g("<div class='input-group' style='width:100%;'></div>").append(i)),j=g('input[type="search"]',b).val(d.sSearch.replace('"',"&quot;")).bind("keyup.DT search.DT input.DT paste.DT cut.DT",function(){var b=!this.value?"":this.value;b!=d.sSearch&&(aa(a,{sSearch:b,bRegex:d.bRegex,bSmart:d.bSmart,bCaseInsensitive:d.bCaseInsensitive}),a._iDisplayStart=0,L(a))}).bind("keypress.DT",function(a){if(13==a.keyCode)return!1}).attr("aria-controls",c);g(a.nTable).on("filter.DT",function(){try{j[0]!==S.activeElement&&j.val(d.sSearch)}catch(a){}});
...
e=0,j=f.length;e<j;e++)i[0][e]=new Option(d[e],f[e]);b=g("<div><label/></div>").addClass(b.sLength);a.aanFeatures.l||(b[0].id=c+"_length");c=a.oLanguage.sLengthMenu.split(/(_MENU_)/);b.children().append(c[0]).append(i).append('<label style="font-size:10px;float:right;margin-left:5px;">'+c[2]+'</label>');i.val(a._iDisplayLength).bind("change.DT",function(){Na(a,g(this).val());L(a)});g(a.nTable).bind("length",function(a,b,c){i.val(c)});return b[0]}function lb(a){var b=a.sPaginationType,c=o.ext.pager[b],d="function"===typeof c,e=function(a){L(a)},b=g("<div/>").addClass(a.oClasses.sPaging+
...
v("columns().header()","column().header()",function(){return this.iterator("columna",function(a,b){return a.aoColumns[b].nTh})});v("columns().footer()","column().footer()",function(){return this.iterator("column",function(a,b){return a.aoColumns[b].nTf})});v("columns().data()","column().data()",function(){return this.iterator("column-rows",function(a,b,c,d,e){for(var c=[],d=0,f=e.length;d<f;d++)c.push(x(a,e[d],b,""));return c})});v("columns().cache()","column().cache()",function(a){return this.iterator("column-rows",
...
v("cells().nodes()","cell().node()",function(){return this.iterator("celda",function(a,b,c){return a.aoData[b].anCells[c]})});q("cells().data()",function(){return this.iterator("cell",function(a,b,c){return x(a,b,c)})});v("cells().cache()","cell().cache()",function(a){a="search"===a?"_aFilterData":"_aSortData";return this.iterator("cell",function(b,c,d){return b.aoData[c][a][d]})});v("cells().indexes()","cell().index()",function(){return this.iterator("cell",function(a,b,c){return{row:b,column:c,columnVisible:X(a,
...
b){var c=this.rows(b).nodes(),c=g(c);return g([].concat(c.filter(a).toArray(),c.find(a).toArray()))});g.each(["en","un","fuera"],function(a,b){q(b+"()",function(){var a=Array.prototype.slice.call(arguments);-1===a[0].indexOf(".dt")&&(a[0]+=".dt");var d=g(this.tables().nodes());d[b].apply(d,a);return this})});q("clear()",function(){return this.iterator("tabla",function(a){ja(a)})});q("settings()",function(){return new s(this.context,this.context)});q("data()",function(){return this.iterator("table",
function(a){return B(a.aoData,"_aData")}).flatten()});q("destroy()",function(a){a=a||!1;return this.iterator("tabla",function(b){var c=b.nTableWrapper.parentNode,d=b.oClasses,e=b.nTable,f=b.nTBody,i=b.nTHead,j=b.nTFoot,h=g(e),f=g(f),k=g(b.nTableWrapper),l=g.map(b.aoData,function(a){return a.nTr}),n;b.bDestroying=!0;u(b,"aoDestroyCallback","destruir",[b]);a||(new s(b)).columns().visible(!0);k.unbind(".DT").find(":not(tbody *)").unbind(".DT");g(R).unbind(".DT-"+b.sInstance);e!=i.parentNode&&(h.children("thead").remove(),
...
{aDataSort:null,asSorting:null,bSearchable:null,bSortable:null,bVisible:null,_sManualType:null,_bAttrSrc:!1,fnCreatedCell:null,fnGetData:null,fnSetData:null,mData:null,mRender:null,nTh:null,nTf:null,sClass:null,sContentPadding:null,sDefaultContent:null,sName:null,sSortDataType:"std",sSortingClass:null,sSortingClassJUI:null,sTitle:null,sType:null,sWidth:null,sWidthOrig:null};o.defaults={aaData:null,aaSorting:[[0,"asc"]],aaSortingFixed:[],ajax:null,aLengthMenu:[5,10,25,50,100],aoColumns:null,aoColumnDefs:null,
...
oClasses:{},oLanguage:{oAria:{sSortAscending:": activar para ordenar ascendente columna",sSortDescending:": activar para ordenar la columna descendente"},oPaginate:{sFirst:"Primero",sLast:"Ultimo",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No hay datos disponibles para mostrar.",sInfo:"Mostrar _START_ a _END_ de _TOTAL_ entradas",sInfoEmpty:"Mostrar 0 a 0 de 0 entradas",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Mostar _MENU_ entradas",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",
sSearch:"<span class='input-group-addon' style='width:1%;'><i class='glyphicon glyphicon-search'></i></span>",sUrl:"",sZeroRecords:"No hay registros coincidentes encontrados"},oSearch:g.extend({},o.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};T(o.defaults);o.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,bSortable:!0,bVisible:!0,fnCreatedCell:null,mData:null,mRender:null,sCellType:"td",sClass:"",sContentPadding:"",sDefaultContent:null,
...
sStripeOdd:"odd",sStripeEven:"even",sRowEmpty:"dataTables_empty",sWrapper:"dataTables_wrapper",sFilter:"dataTables_filter",sInfo:"dataTables_info",sPaging:"dataTables_paginate paging_",sLength:"dataTables_length",sProcessing:"dataTables_processing",sSortAsc:"Ascendente",sSortDesc:"Decendene",sSortable:"Ordenando",sSortableAsc:"sorting_asc_disabled",sSortableDesc:"sorting_desc_disabled",sSortableNone:"sorting_disabled",sSortColumn:"sorting_",sFilterInput:"",sLengthSelect:"",sScrollWrapper:"dataTables_scroll",
